...
struct RadarModule
{
    ...
    explicit RadarModule(RadarParams input)
        : params(finalize(std::move(input)))
    {
    }
...
private:
    ...
    static RadarParams finalize(RadarParams params)
    {
        ...
        params.minimum_detection_range_m =
            299792458.0 * params.pulse_width_s / 2.0;
        params.maximum_unambiguous_range_m =
            299792458.0 * params.pri_s / 2.0;
